...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Estimado/a <strong>Dr. <?php echo e($doctor_name); ?></strong>,</p>
            ...
            <a href="<?php echo e($login_url); ?>" class="button">IR AL PANEL MÉDICO</a>
        </div>
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> Telemedicina. Todos los derechos reservados.
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\telemedicina\resources\views/emails/payment_registered_doctor.blade.php ENDPATH**/ ?>